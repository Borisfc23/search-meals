    ...
    <div class="mx-6 py-10 text-center md:text-left">
      <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="">
          ...
          <p>
            Delicious homemade dishes, authentic flavors, fast delivery. Place
            your order and enjoy today!
          </p>
        </div>
        <!-- Products section -->
        <div>
        ...
        <div>
          ...
          <p class="mb-4">
            <a href="#!">Searh Letter</a>
          </p>
          <p class="mb-4">
            <a href="#!">Searh Ingredient</a>
          </p>
          <p>
            <a href="#!">Home</a>
          </p>
