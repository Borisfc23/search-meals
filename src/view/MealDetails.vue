<template>
  <template v-if="meal && meal.strMeal">
    <div class="md:w-[800px] mx-auto p-2 sm:p-8">
      <h1 class="text-4xl font-bold mb-5 text-red-600">
        {{ meal.strMeal }}
      </h1>
      <img
    ...
    <div class="sm:container sm:px-1 px-3 mx-auto pt-5">
      <div class="flex justify-center">
        <div role="status">
          <svg
            aria-hidden="true"
            class="w-20 h-20 text-gray-200 animate-spin dark:text-gray-300 fill-red-600"
            viewBox="0 0 100 101"
            fill="none"
